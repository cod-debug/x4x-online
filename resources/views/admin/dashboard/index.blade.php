        ...
        <div class="row">
            ...
            <div class="col-12 col-sm-6 col-md-3">
                <div class="info-box mb-3">
                    ...
                    <div class="info-box-content">
                      <span class="info-box-text">Incorporation Commision</span>
            ...
            <div class="col-12 col-sm-6 col-md-3">
                <div class="info-box mb-3">
                    ...
                    <div class="info-box-content">
                      <span class="info-box-text">Sub Operator Commision</span>
            ...
            <div class="col-12 col-sm-6 col-md-3">
                <div class="info-box mb-3">
                    ...
                    <div class="info-box-content">
                      <span class="info-box-text">Master Agent  Commisions</span>
            ...
            <div class="col-12 col-sm-6 col-md-3">
                <div class="info-box mb-3">
                    ...
                    <div class="info-box-content">
                      <span class="info-box-text">Agent Commisions</span>
            ...
            <div class="col-12 col-sm-6 col-md-3">
                <div class="info-box mb-3">
                    ...
                    <div class="info-box-content">
                      <span class="info-box-text">Downlines Credits</span>
            ...
            <div class="col-12 col-sm-6 col-md-3">
                <div class="info-box mb-3">
                    ...
                    <div class="info-box-content">
                    <span class="info-box-text">General Points</span>
        ...
        <div class="row mt-5">
            <div class="col-12 col-sm-6 col-md-3">
                <div class="info-box mb-3">
                    ...
                    <div class="info-box-content">
                      <span class="info-box-text">Incorporator Withdrawals</span>
            ...
            <div class="col-12 col-sm-6 col-md-3">
                <div class="info-box mb-3">
                    ...
                    <div class="info-box-content">
                      <span class="info-box-text">Inco Comm. Withdrawals</span>
